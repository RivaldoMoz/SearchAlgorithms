...
if __name__=='__main__':
    ...
    c=agent(m,5,1,footprints=True,color=COLOR.red)
    m.tracePath({a:dSeacrh},showMarked=True)
    l=textLabel(m,'The breadth First Search Length',len(fwdPath)+1)
    l=textLabel(m,'The breadth First Search Length',len(dSeacrh))
